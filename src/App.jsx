...
const initialTransactions = [
  { id:  1, assetId: 1, type: "Buy", amount: 3000/97200,  price: 97200,  fee: 0, date: "2025-11-21", note: "" },
  { id:  2, assetId: 1, type: "Buy", amount: 3000/104500, price: 104500, fee: 0, date: "2025-12-15", note: "" },
  { id:  3, assetId: 1, type: "Buy", amount: 3000/93400,  price: 93400,  fee: 0, date: "2025-12-31", note: "" },
  { id:  4, assetId: 1, type: "Buy", amount: 3000/101800, price: 101800, fee: 0, date: "2026-01-17", note: "" },
  { id:  5, assetId: 1, type: "Buy", amount: 3000/96200,  price: 96200,  fee: 0, date: "2026-02-03", note: "" },
  { id:  6, assetId: 1, type: "Buy", amount: 3000/97800,  price: 97800,  fee: 0, date: "2026-02-15", note: "" },
  { id:  7, assetId: 1, type: "Buy", amount: 3000/86500,  price: 86500,  fee: 0, date: "2026-03-07", note: "" },
  { id:  8, assetId: 1, type: "Buy", amount: 3000/83200,  price: 83200,  fee: 0, date: "2026-03-18", note: "" },
  { id:  9, assetId: 1, type: "Buy", amount: 3000/82400,  price: 82400,  fee: 0, date: "2026-04-05", note: "" },
  { id: 10, assetId: 1, type: "Buy", amount: 3000/87100,  price: 87100,  fee: 0, date: "2026-04-20", note: "" },
];
...
export default function App() {
  ...
  const fetchPrice = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        setPrices({ 1: p2 }); setPriceStatus("live"); setLastUpdated(new Date());
  ...
  const addTx = async () => {
    ...
    try {
      await fetch(TABLE, { method: "POST", headers: HEADERS, body: JSON.stringify({ id: newTx.id, asset_id: newTx.assetId, type: newTx.type, amount: newTx.amount, price: newTx.price, fee: newTx.fee, date: newTx.date, note: newTx.note }) });
  ...
  const delTx = async (id) => {
    ...
    try { await fetch(`${TABLE}?id=eq.${id}`, { method: "DELETE", headers: HEADERS }); } catch { console.warn("delete failed"); }
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, background: "#141420", border: "1px solid #2A2A3A", borderRadius: 8, padding: "5px 12px", fontSize: 12 }}>
            ...
            {priceStatus === "live" && lastUpdated && (
              <span style={{ color: "#555", fontSize: 10 }}>{lastUpdated.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}</span>
            )}
            ...
            {view === "dashboard" && holdings.length > 0 && (() => {
              ...
              return (
                <>
                  ...
                  <div className="card">
                    <div className="lbl" style={{ marginBottom: 12 }}>DCA Buy History — {transactions.length} purchases × $3,000 USDT</div>
